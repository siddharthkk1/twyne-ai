...
export const HeroSectionV2 = ({ 
  ...
  return (
    <section className="relative py-10 md:py-24 mt-16 md:mt-24 overflow-hidden bg-white min-h-[85vh] flex flex-col items-center">
      ...
      {/* Images container with responsive positioning - ADJUSTED DOWN BY 40% */}
      <div className="absolute bottom-8 w-full max-w-[1600px] mx-auto">
        ...
        <div 
          ...
          style={{ 
            ...
            width: `${coffeeImageWidth*1.1}px`  /* Use the same width as coffee image */
          }}
        >
          <div className="relative">
            <img 
              ...
              className="h-auto object-contain"
              style={{ width: `${coffeeImageWidth*1.1}px` }}
          ...
          >
            {user ? (
              <Button asChild size="lg" className="rounded-full px-8 hover-scale w-full sm:w-auto">
                <Link to="/mirror" className="flex items-center">
                  View Your Mirror
              ...
              <div className="flex flex-col sm:flex-row sm:space-x-4 items-center w-full">
                {/* Get Started button with purple-to-pink gradient */}
                <Button 
                  size="lg" 
