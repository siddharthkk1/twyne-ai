...
export function Toaster() {
  ...
  const positions = {
    ...
    // Modified center position to move it higher up vertically (40% from top instead of 50%)
    "center": "fixed top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 flex-col",
