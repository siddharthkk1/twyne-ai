...
export function Toaster() {
  ...
  const positions = {
    ...
    // Modified center position to move it higher up vertically (10% from top instead of 40%)
    "center": "fixed top-[10%] left-1/2 -translate-x-1/2 -translate-y-1/2 flex-col",
